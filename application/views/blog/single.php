        ...
        <div class="blog-posts-area">
          ...
          <div class="single-blog-post featured-post single-post">
            <div class="post-thumb" style="height: auto;">
              <a>
                <img class="single" style="height: auto;" src="<?php echo $single_blog['picture']; ?>" alt="<?php echo $single_blog['title']; ?>">
              </a>
            </div>
            <div class="post-data">
              ...
              <div class="post-meta">
                ...
                <div class="newspaper-post-like d-flex align-items-center justify-content-between">
                  ...
                  <div class="d-flex align-items-center post-like--comments">
                    <a class="post-like">
                      <i class="fa fa-eye color"></i> <span><?php echo $single_blog['views']; ?></span>
                    </a>
                    <a class="post-comment">
                      <i class="fa fa-comments-o color"></i> <span><?php echo $single_blog['comments']; ?></span>
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="single-blog-post small-featured-post d-flex">
                  ...
                  <div class="post-data">
                    ...
                    <div class="post-meta">
                      ...
                      <p class="post-date">
                        <?php echo date('h:i A | F d', strtotime($latest_blog[$i]['date'])); ?>
                      </p>
                    </div>
                  </div>
                </div>
