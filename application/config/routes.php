...
$route['dashboard/inbox/']        = 'administrator/messages';          # access (administrator)
$route['dashboard/inbox/(:any)']  = 'administrator/single_message/$1'; # access (administrator)
$route['dashboard/inbox/delele']  = 'administrator/delete_message';    # access (administrator)
